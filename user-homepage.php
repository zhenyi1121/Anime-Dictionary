...
<div class="homepage-container">
    <div class="welcome-message">
        ...
        <p>Explore the best anime recommendations and featuring your favorite anime series.</p>
        <p>Stay tuned for the latest updates and fun quizzes!</p>
        <p>Now Available Quiz:</p>
        <ul>
