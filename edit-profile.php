...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE users SET Username = ?, NoTelephone = ?, Email = ?, Avatar = ? WHERE NoIC = ?";
    $update_stmt = mysqli_prepare($condb, $update_query);
    mysqli_stmt_bind_param($update_stmt, "sssss", $new_username, $new_phone, $new_email, $new_avatar, $NoIC);
