...
<div class="homepage-container">
    ...
    <h1>Welcome to the ANIME DICTIONARY [Admin Panel]</h1>
    <p>Manage the anime database and quizzes.</p>
    <p>Ready to get started? Use the navigation menu on the top.</p>
    <p>Current Anime Quiz :</p>
    <ul>
